...
import { Truck, Plus, X, Check, Phone, Mail } from 'lucide-react'
        ...
        <div>
            ...
            {showForm && (
                <div className="glass-card" style={{ padding: '20px', marginBottom: '16px' }}>
                    <form onSubmit={handleCreate} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr auto', gap: '12px', alignItems: 'end' }}>
                        <div>
