...
interface ItemMenu { href: string; label: string; icon: LucideIcon; exact?: boolean }
...
// Aba restrita: só entra no menu de quem é admin no módulo Obras. A página
...
export default function ObrasNav({ isAdmin, children }: { isAdmin: boolean; children: React.ReactNode }) {
    ...
    const itens = isAdmin ? [...navItems, ...navAdmin] : navItems
