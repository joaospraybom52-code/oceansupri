...
import { LogIn, Eye, EyeOff, Package, HardHat, ArrowLeft, LineChart } from 'lucide-react'
...
export default function LoginForm() {
    ...
    const isControle = modulo === 'controle'
    const redirectPath = isObras ? '/obras-eng' : isControle ? '/controle' : '/board'
    ...
    return (
        <div style={{
            ...
            backgroundImage: isObras
                ...
                : isControle
                ? 'radial-gradient(ellipse at 30% 20%, rgba(245, 158, 11, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(217, 119, 6, 0.06) 0%, transparent 50%)'
